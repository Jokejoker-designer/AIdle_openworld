## Cozy third-person / 2.5D player controller.
## Movement is camera-relative on XZ plane; soft gravity; no combat twitch.
...
func _physics_process(delta: float) -> void:
	...
	# Jump optional – cozy feel, short hop.
...
func _camera_relative_direction(input_dir: Vector2) -> Vector3:
	...
	if _camera_rig and _camera_rig.has_method("get_yaw"):
		basis_yaw = _camera_rig.call("get_yaw")
	elif _camera_rig:
