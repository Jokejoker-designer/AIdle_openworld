...
| Trường | Giá trị |
|---|---|
| Character ID | `AC-CA-016` |
| World Profile | Arcane Clockwork |
| Character Class | `CREATURE_AMBIENT` |
| Species/Form | Bướm lưu trữ bằng giấy |
| Gameplay Role | Lưu và tìm bản vẽ |
| Rig Family | `Archive-moth-01; 2 wing pages; 2 hinge bones.` |
| Status đề xuất | Concept / Production-ready specification |

## 2. Character Hook

> Một sinh vật giấy-đồng có đôi cánh như trang sách và rune thay đổi theo ký ức.

## 3. Vai trò trong thế giới

Quillix được thiết kế để phục vụ trực tiếp cho vòng lặp gameplay của **Arcane Clockwork**.  
...
Vai trò chính của nhân vật là **Lưu và tìm bản vẽ**. Nhân vật phải tạo ra giá trị gameplay rõ ràng, nhưng không được trở thành một hệ thống tự trị có quyền thay đổi world state, ownership, inventory hoặc economy nếu chưa qua authority và confirmation.

## 4. Thiết kế hình thể và silhouette

**Silhouette chủ đạo:** Hai cánh trang sách lớn, thân nhỏ, bản lề đồng và mắt teal.

**Mô tả hình ảnh chi tiết:**  
Giấy ấm, vàng nhạt, teal; rune không đọc được để tránh text artifact.
...
**Phong cách hội thoại:** Không nói; chỉ rune pattern và chuyển động cánh.
...
Tìm blueprint, đánh dấu recipe cũ và nhận biết phiên bản.

### Giới hạn bắt buộc

Không mang dữ liệu ngoài quyền truy cập và không sửa bản vẽ.

### Vị trí xuất hiện

Kho lưu trữ, workbench, thư viện máy.

### Quan hệ gợi ý

Theo Brassel; ghi lịch Oria; đậu trên Cinder-04.

## 7. Chuyển động và animation

**Locomotion:** Bay mềm, lật cánh như trang sách.

**Idle behaviors:** Đậu, mở cánh, đổi rune, gấp lại.

**Signature animation:** Hai cánh mở thành một bản vẽ hologram phẳng.
...
**Audio identity:** Lật giấy, bản lề nhỏ và ping rune.
...
```text
Create Quillix, a small archive moth made from folded parchment and thin brass hinges. Its two wings resemble open book pages with shifting non-readable rune patterns. Use warm paper, muted gold and one teal eye-light. The creature should move softly and intelligently, never look like a real-world moth enlarged.
...
REFERENCE ARCHETYPE:
- Original character: Quillix
- World: Arcane Clockwork
- Function to preserve: Lưu và tìm bản vẽ
- Core silhouette principle: Hai cánh trang sách lớn, thân nhỏ, bản lề đồng và mắt teal.
- Core limitation to preserve: Không mang dữ liệu ngoài quyền truy cập và không sửa bản vẽ.
