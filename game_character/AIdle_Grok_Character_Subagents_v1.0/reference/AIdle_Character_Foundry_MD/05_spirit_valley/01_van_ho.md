...
| Trường | Giá trị |
|---|---|
| Character ID | `SV-SE-017` |
| World Profile | Spirit Valley |
| Character Class | `SPIRIT_ENTITY` |
| Species/Form | Cáo mây |
| Gameplay Role | Linh vật mây và mưa |
| Rig Family | `Quadruped-spirit-01; cloud clusters shader; tail mist spline.` |
| Status đề xuất | Concept / Production-ready specification |

## 2. Character Hook

> Một cáo mây nhút nhát chỉ gọi mưa khi đã tin tưởng người chơi.

## 3. Vai trò trong thế giới

Vân Hồ được thiết kế để phục vụ trực tiếp cho vòng lặp gameplay của **Spirit Valley**.  
...
Vai trò chính của nhân vật là **Linh vật mây và mưa**. Nhân vật phải tạo ra giá trị gameplay rõ ràng, nhưng không được trở thành một hệ thống tự trị có quyền thay đổi world state, ownership, inventory hoặc economy nếu chưa qua authority và confirmation.

## 4. Thiết kế hình thể và silhouette

**Silhouette chủ đạo:** Tai cáo rõ, thân cụm mây, chân ngắn và đuôi dài tan vào sương.

**Mô tả hình ảnh chi tiết:**  
Trắng, xanh nhạt, xám mềm, ánh trăng; không dùng lông thật.
...
**Phong cách hội thoại:** Không nói; biểu đạt bằng mây, tai, đuôi và âm gió.
...
Dẫn đến nguồn nước và gọi mưa nhẹ trong sự kiện đã xác nhận.

### Giới hạn bắt buộc

Không thay đổi khí hậu toàn vùng hoặc xuất hiện ở rừng suy kiệt nặng.

### Vị trí xuất hiện

Sườn núi, hồ sen, mây thấp hoặc rừng phục hồi.

### Quan hệ gợi ý

Theo Đăng Tâm; được Trúc Nhi bảo vệ; ngủ trên mai Mộc Ông.

## 7. Chuyển động và animation

**Locomotion:** Trôi, bước mây và nhảy ngắn.

**Idle behaviors:** Cuộn đuôi sương, ngửi không khí, tan một phần rồi tụ lại.

**Signature animation:** Ngẩng đầu; mây xoắn thành vòng và mưa nhẹ rơi.
...
**Audio identity:** Gió, chuông xa và mưa nhỏ.
...
```text
Create Vân Hồ, a shy cloud fox spirit for a stylized Eastern myth-inspired 2.5D world. Build the body from soft low-poly cloud clusters while keeping the ears, paws and face clearly readable. Give it a long tail that dissolves into mist. Use white, pale blue, soft gray and subtle moonlight highlights. Avoid realistic fur and avoid copying existing fox mascots.
...
REFERENCE ARCHETYPE:
- Original character: Vân Hồ
- World: Spirit Valley
- Function to preserve: Linh vật mây và mưa
- Core silhouette principle: Tai cáo rõ, thân cụm mây, chân ngắn và đuôi dài tan vào sương.
- Core limitation to preserve: Không thay đổi khí hậu toàn vùng hoặc xuất hiện ở rừng suy kiệt nặng.
