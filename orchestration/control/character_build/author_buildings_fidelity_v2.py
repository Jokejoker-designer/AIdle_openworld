# -*- coding: utf-8 -*-
"""BUILDINGS_FIDELITY_V2 — fidelity V2 — denser SSOT detail for 8 buildings from MOCKUP_SSOT_V2 cards.
...
def build_workshop():
    ...
    roof_tiles_gable("Roof", 0, 0, 1.30, 1.05, 0.95, 0.80, [Mr1, Mr2, Mr3], rows=5, cols=6)
    cube("Ridge", (0, 0, 2.10), (1.95, 0.20, 0.16), Mr1, 0.06)
    cyl("Chimney", (0.55, -0.40, 2.20), 0.13, 0.50, mat("M_chim", (0.96, 0.93, 0.88), 0.55), 10)
...
def build_barn():
    ...
    roof_tiles_gable("Roof", 0, 0, 1.50, 1.15, 1.0, 0.75, [Mr1, Mr2, Mr3], rows=5, cols=6)
    cube("Ridge", (0, 0, 2.28), (2.05, 0.18, 0.14), Mr2, 0.05)
...
def export_module(module_id: str) -> dict:
    ...
    return {"module_id": module_id, "glb_sha256": dig, "bytes": size, "source": JOB, "visual": f"mockup_{module_id}_v2", "mockup_ssot": module_id}
