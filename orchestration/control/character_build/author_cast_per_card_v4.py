# -*- coding: utf-8 -*-
"""CAST_PER_CARD_V4 — individual SSOT card polish (not shared presenter).
...
def body_nori(parts, mats):
    ...
    parts += [
        ...
        # SSOT eye: dark socket + cyan ring + bright core
        sphere("eyeSocket", (0.0, 0.28, 0.94), (0.16, 0.10, 0.16), metal),
        sphere("eyeRing", (0.0, 0.32, 0.94), (0.12, 0.07, 0.12), glass),
        sphere("eyePupil", (0.0, 0.36, 0.94), (0.055, 0.03, 0.055), metal),
        sphere("eyeCore", (0.0, 0.38, 0.94), (0.03, 0.018, 0.03), glass),
