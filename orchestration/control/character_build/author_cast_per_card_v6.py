# -*- coding: utf-8 -*-
"""CAST_PER_CARD_V6 — individual SSOT card polish (not shared presenter).
...
def body_nori(parts, mats):
    ...
    parts += [
        ...
        # SSOT dual-facing eyes (+Y freecam-ish and -Y)
        sphere("eyeSocketF", (0.0, 0.28, 0.94), (0.16, 0.10, 0.16), metal),
        sphere("eyeRingF", (0.0, 0.33, 0.94), (0.12, 0.07, 0.12), glass),
        sphere("eyePupilF", (0.0, 0.37, 0.94), (0.055, 0.03, 0.055), metal),
        sphere("eyeCoreF", (0.0, 0.39, 0.94), (0.03, 0.018, 0.03), glass),
        sphere("eyeSocketB", (0.0, -0.26, 0.94), (0.14, 0.09, 0.14), metal),
        sphere("eyeRingB", (0.0, -0.30, 0.94), (0.11, 0.06, 0.11), glass),
        sphere("eyeSide", (0.24, 0.08, 0.94), (0.11, 0.08, 0.11), glass),
        sphere("eyeSideP", (0.28, 0.10, 0.94), (0.045, 0.03, 0.045), metal),
...
def body_bac_bap(parts, mats):
    ...
    parts += [
        ...
        # mustache (SSOT thick brown walrus)
        sphere("mustL", (-0.06, 0.18, 0.95), (0.08, 0.055, 0.035), brown),
        sphere("mustR", (0.06, 0.18, 0.95), (0.08, 0.055, 0.035), brown),
        sphere("mustMid", (0.0, 0.19, 0.94), (0.05, 0.04, 0.03), brown),
        # thick brows
        sphere("browL", (-0.07, 0.16, 1.07), (0.07, 0.04, 0.025), brown),
        sphere("browR", (0.07, 0.16, 1.07), (0.07, 0.04, 0.025), brown),
        # smile
        sphere("mouth", (0.0, 0.17, 0.92), (0.04, 0.02, 0.015), cream),
        # eyes
        ...
        # toolbox (SSOT rectangular case + handle + latches)
        cyl("box", (0.0, 0.30, 0.40), 0.14, 0.22, metal, (math.pi / 2, 0, 0)),
        sphere("boxBody", (0.0, 0.30, 0.40), (0.16, 0.10, 0.12), metal),
        sphere("boxHandle", (0.0, 0.42, 0.50), (0.09, 0.03, 0.03), metal),
        sphere("latchL", (-0.08, 0.38, 0.42), (0.03, 0.02, 0.02), cream),
        sphere("latchR", (0.08, 0.38, 0.42), (0.03, 0.02, 0.02), cream),
        # side tool
        cyl("wrench", (0.42, 0.12, 0.45), 0.02, 0.22, metal, (0.3, 0, 0.5)),
        # shoulder strap
...
def body_kito(parts, mats):
    ...
    parts += [
        ...
        sphere("eyeL", (-0.11, 0.26, 0.90), (0.11, 0.07, 0.11), glass),
        sphere("eyeR", (0.11, 0.26, 0.90), (0.11, 0.07, 0.11), glass),
        sphere("eyeDotL", (-0.11, 0.30, 0.90), (0.04, 0.025, 0.04), metal),
        sphere("eyeDotR", (0.11, 0.30, 0.90), (0.04, 0.025, 0.04), metal),
...
CHARACTERS = [
    {
        ...
        "colors": {
            "cream": (0.72, 0.68, 0.50, 1), "shade": (0.58, 0.54, 0.40, 1),
            "leaf": (0.22, 0.72, 0.28, 1), "wood": (0.40, 0.55, 0.30, 1),
            "glass": (0.05, 0.95, 1.0, 1), "metal": (0.35, 0.38, 0.42, 1),
            "accent": (0.20, 0.65, 0.30, 1),
        },
    },
    {
    ...
    },
    {
        ...
        "colors": {
            "cream": (0.98, 0.42, 0.15, 1),  # stronger orange coveralls
            "shade": (0.88, 0.65, 0.48, 1),  # tan skin
