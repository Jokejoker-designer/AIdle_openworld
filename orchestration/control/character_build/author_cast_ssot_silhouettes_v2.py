# -*- coding: utf-8 -*-
"""CAST_SSOT_SILHOUETTES_V2 — re-author all 10 town-cadastre cast GLBs.
...
def body_nori_pear(parts, mats):
    ...
    parts += [
        ...
        # single cyan eye
        sphere("eye", (0.0, 0.28, 0.82), (0.14, 0.08, 0.14), glass),
        sphere("pupil", (0.0, 0.34, 0.82), (0.055, 0.04, 0.055), metal),
        # green snout/barrel (larger for freecam)
        cyl("snout", (0, 0.36, 0.70), 0.075, 0.28, leaf, (math.pi / 2, 0, 0)),
        # arms
...
def body_robot(parts, mats):
    ...
    parts += [
        ...
        sphere("eyeL", (-0.09, 0.24, 0.86), (0.085, 0.055, 0.085), glass),
        sphere("eyeR", (0.09, 0.24, 0.86), (0.085, 0.055, 0.085), glass),
...
CHARACTERS = [
    {
        ...
        "nori_path": True,
        "colors": {
            "cream": (0.82, 0.76, 0.58, 1),
            "shade": (0.72, 0.66, 0.50, 1),
            "leaf": (0.28, 0.72, 0.28, 1),
    ...
    },
    {
        ...
        "leaves": True,
        "colors": {
            "cream": (0.90, 0.82, 0.68, 1),
            "shade": (0.78, 0.70, 0.55, 1),
    ...
    },
    {
        ...
        "form": "robot",
        "colors": {
            "cream": (0.88, 0.82, 0.68, 1),
            "shade": (0.78, 0.72, 0.58, 1),
            "leaf": (0.35, 0.80, 0.30, 1),
...
def update_roster(results):
    ...
    for r in results:
        ...
        row["source"] = JOB
        row["visual"] = "cast_ssot_silhouettes_v2"
