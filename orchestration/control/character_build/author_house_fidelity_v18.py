# -*- coding: utf-8 -*-
"""HOUSE_FIDELITY_V18 — SSOT-closer clay fish-scale + front door prominence.
...
def build():
    ...
    Mr1 = mat("M_roof_a", (1.0, 0.55, 0.28), 0.48)   # peach
    Mr2 = mat("M_roof_b", (1.0, 0.82, 0.18), 0.45)   # yellow
    Mr3 = mat("M_roof_c", (0.98, 0.86, 0.55), 0.50)  # cream-peach
    ...
    cube("DFr", (0, 0.68, 0.44), (0.52, 0.07, 0.84), Mf, 0.05)
    cube("Door", (0, 0.76, 0.44), (0.44, 0.09, 0.74), Md, 0.05)
    # Door planks
    cube("DP1", (0, 0.72, 0.52), (0.36, 0.02, 0.02), Mdark, 0.0)
    cube("DP2", (0, 0.72, 0.36), (0.36, 0.02, 0.02), Mdark, 0.0)
    sph("DArch", (0, 0.76, 0.86), 0.24, Mf, (1.1, 0.35, 0.6))
    sph("Knob", (0.14, 0.82, 0.42), 0.05, Mknob)
    # Steps (peach)
