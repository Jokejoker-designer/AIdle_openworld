# -*- coding: utf-8 -*-
"""HOUSE_FIDELITY_V20 — half-disc clay scales + door clear of HOME.CHAR occlusion.
...
def half_disc(name, u, t, front, m):
    ...
    x = u * 0.88
    r = 0.155 - 0.025 * t  # larger at eave
