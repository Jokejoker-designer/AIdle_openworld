# -*- coding: utf-8 -*-
"""HOUSE_FIDELITY_V22 — SSOT soft clay half-discs + side interior window detail.
...
def build():
    ...
    Mr1 = mat("M_roof_a", (1.0, 0.78, 0.58), 0.50)
    Mr2 = mat("M_roof_b", (1.0, 0.90, 0.48), 0.48)
    Mr3 = mat("M_roof_c", (0.99, 0.94, 0.80), 0.52)
