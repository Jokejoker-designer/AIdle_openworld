# -*- coding: utf-8 -*-
"""HOUSE_FIDELITY_V24 — SSOT soft clay half-discs + side interior window detail.
...
def build():
    ...
    # Soft wall clay texture beads (SSOT stucco feel)
    for i, (x, y, z) in enumerate([
        (-0.55, -0.50, 0.75), (0.50, -0.50, 0.55), (-0.40, 0.45, 0.70),
        (0.35, 0.50, 0.80), (-0.60, 0.20, 0.45), (0.55, -0.20, 0.50),
    ]):
        sph(f"WallBead{i}", (x, y, z), 0.06, Mw, (1.4, 0.9, 1.1))
