# -*- coding: utf-8 -*-
"""Tick #74: inventory + deviation after boolean wave. Re-render proofs."""
import bpy
import os
import shutil
...
WORK = os.path.join(BASE, "ROYAL_LIGHTKEEP_WATCHTOWER_BARRACKS_01_PASS8_V51_BOOLTWR.blend")
...
- Portal/hall/tower boolean recesses for opening depth
- Fort wall 6.5, setbacks, gallery, arcade, merlons, hip, flags, paving
- Bevel soft edges on many structural masses
...
## Overall ~7.95 — not FINAL until Human overlay
Boolean wave improved depth; still not mockup-faithful without mesh-language rebuild.
""")
...
out_blend = os.path.join(BASE, "ROYAL_LIGHTKEEP_WATCHTOWER_BARRACKS_01_PASS8_V52_SNAP3.blend")
