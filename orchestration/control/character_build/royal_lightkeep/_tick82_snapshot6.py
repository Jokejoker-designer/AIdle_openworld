# -*- coding: utf-8 -*-
"""Tick #82: inventory + deviation after cope densify. Re-render."""
import bpy
import os
import shutil
...
WORK = os.path.join(BASE, "ROYAL_LIGHTKEEP_WATCHTOWER_BARRACKS_01_PASS8_V59_COPE.blend")
...
with open(os.path.join(BASE, "INTERMEDIATE_DEVIATION_REPORT.md"), "w", encoding="utf-8") as f:
    f.write(f"""# INTERMEDIATE DEVIATION REPORT — tick #82

**Asset:** ROYAL_LIGHTKEEP_WATCHTOWER_BARRACKS_01
**Stamp:** {STAMP}
**File:** PASS8_V60_SNAP6 / PASS1D
...
- Entry tunnel + channel + portal/hall/tower/wing booleans
- Copestones + merlon caps, fort wall 6.5, setbacks, gallery, arcade
...
Parapet cope densify done. Modular plateau vs carved gothic mockup remains.
""")
...
out_blend = os.path.join(BASE, "ROYAL_LIGHTKEEP_WATCHTOWER_BARRACKS_01_PASS8_V60_SNAP6.blend")
