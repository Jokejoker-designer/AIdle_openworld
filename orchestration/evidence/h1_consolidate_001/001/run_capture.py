#!/usr/bin/env python3
"""H1-CONSOLIDATE-001 H3 headed real-input capture runner (VERIFY_ONLY evidence lease).

Fresh fail-closed harness under evidence/h1_consolidate_001/001 only.
...
EVIDENCE = ROOT / "orchestration" / "evidence" / "h1_consolidate_001" / "001"
SCRIPT = EVIDENCE / "capture_h1_consolidate_h3_real_input.gd"
...
def main() -> int:
    ...
    user_data = Path(os.environ.get("TEMP", "/tmp")) / f"h1c_h3_userdata_{ts}"
    ...
    marker_pass = "AIDLE_H1C_H3_HEADED=PASS" in combined
    ...
    manifest = {
        "schema": "h1_consolidate_001_h3_evidence_manifest/1.0",
