#!/usr/bin/env python3
"""H1-CONSOLIDATE-001 W2 headed Manual Build capture runner (VERIFY_ONLY evidence 004)."""
...
SCRIPT = EVIDENCE / "capture_h1_w2_manual_build.gd"
...
def main() -> int:
    ...
    user_data = Path(os.environ.get("TEMP", "/tmp")) / f"h1c_w2_userdata_{ts}"
    ...
    marker_pass = "AIDLE_H1C_W2_HEADED=PASS" in combined
    ...
    manifest = {
        "schema": "h1_consolidate_001_w2_evidence_manifest/1.0",
        "work_order": "WO-H1-CONSOLIDATE-001-HUMAN-UX-MANUAL-BUILD-CORRECTION-003",
        "wave": "W2",
        "directive_id": 78,
        ...
        "cmd": cmd,
        "residuals_noted": [
            "tscn may still ship Small Build string (W1-RES-01) while gd runtime uses Manual Build"
        ],
    }
