#!/usr/bin/env python3
"""UCBV-001 C4 headless regression matrix (VERIFY_ONLY evidence lease 002/smokes)."""
...
def run_godot_smoke(sid: str, script: str, marker: str) -> dict:
    ...
    try:
        ...
        return {
            ...
            "error_count": 0,
            "nav_warn_count": 0,
            "log": f"orchestration/evidence/ucbv_001/002/smokes/{sid}.log",
...
def run_block_dna() -> dict:
    ...
    if not dna_script.is_file():
        return {
            ...
            "log": "orchestration/evidence/ucbv_001/002/smokes/block_dna.log",
            "seconds": 0.0,
        }
    try:
        proc = subprocess.run(
...
def main() -> int:
    ...
    summary = {
        "schema": "ucbv_001_c4_smoke_summary/1.0",
        "wave": "C4",
        "directive_id": 91,
        "results": results,
