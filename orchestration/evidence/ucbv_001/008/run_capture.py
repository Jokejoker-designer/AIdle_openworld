#!/usr/bin/env python3
"""UCBV-001 C4 headed dual-res capture runner (VERIFY_ONLY evidence lease 008)."""
...
SCRIPT = EVIDENCE / "capture_ucbv_c4r_headed.gd"
...
def main() -> int:
    ...
    user_data = Path(os.environ.get("TEMP", "/tmp")) / f"ucbv_c4r_userdata_{ts}"
    ...
    marker_pass = "AIDLE_UCBV001_C4R_HEADED=PASS" in combined
    ...
    summary = {
        "schema": "ucbv_001_c4r_headed_runner_summary/1.0",
        "wave": "C4R",
        "directive_id": 94,
