#!/usr/bin/env python3
"""UCBV-001 C4S headed dual-res capture runner (VERIFY_ONLY evidence lease 009)."""
...
EVIDENCE = ROOT / "orchestration" / "evidence" / "ucbv_001" / "009"
SCRIPT = EVIDENCE / "capture_ucbv_c4s_headed.gd"
...
def main() -> int:
    ...
    user_data = Path(os.environ.get("TEMP", "/tmp")) / f"ucbv_c4s_userdata_{ts}"
    ...
    marker_pass = "AIDLE_UCBV001_C4S_HEADED=PASS" in combined
    ...
    summary = {
        "schema": "ucbv_001_c4s_headed_runner_summary/1.0",
        "wave": "C4S",
        "directive_id": 95,
