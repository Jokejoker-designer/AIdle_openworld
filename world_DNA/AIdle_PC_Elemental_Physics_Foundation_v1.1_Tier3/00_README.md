...
## v1.1 Tier 3 Offline Simulation

Tier 3 deterministic offline catch-up is now implemented as a patch foundation. See `docs/TIER3_IMPLEMENTATION.md` and `evidence/tier3/`. Godot headed validation remains required.
